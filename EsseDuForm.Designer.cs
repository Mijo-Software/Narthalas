namespace Narthalas
{
	partial class EsseDuForm
	{
		...
		private void InitializeComponent()
		{
			...
			kryptonLabelLetteA = new Krypton.Toolkit.KryptonLabel();
			...
			kryptonPanel.Controls.Add(kryptonLabelLetteA);
			...
			kryptonNumericUpDown17.Size = new Size(63, 22);
			...
			kryptonNumericUpDown18.Increment = new decimal(new int[] { 1, 0, 0, 0 });
			kryptonNumericUpDown18.Location = new Point(249, 232);
			kryptonNumericUpDown18.Maximum = new decimal(new int[] { 100, 0, 0, 0 });
			kryptonNumericUpDown18.Minimum = new decimal(new int[] { 0, 0, 0, 0 });
			kryptonNumericUpDown18.Name = "kryptonNumericUpDown18";
			kryptonNumericUpDown18.Size = new Size(63, 22);
			...
			kryptonComboBoxLetterA.Items.AddRange(new object[] { "C", "V" });
			kryptonComboBoxLetterA.Location = new Point(39, 10);
			kryptonComboBoxLetterA.Name = "kryptonComboBoxLetterA";
			...
			kryptonLabelLetterAPercent.Name = "kryptonLabelLetterAPercent";
			...
			kryptonNumericUpDownLetterA.Increment = new decimal(new int[] { 1, 0, 0, 0 });
			kryptonNumericUpDownLetterA.Location = new Point(80, 10);
			kryptonNumericUpDownLetterA.Maximum = new decimal(new int[] { 100, 0, 0, 0 });
			kryptonNumericUpDownLetterA.Minimum = new decimal(new int[] { 0, 0, 0, 0 });
			kryptonNumericUpDownLetterA.Name = "kryptonNumericUpDownLetterA";
			kryptonNumericUpDownLetterA.Size = new Size(63, 22);
			...
			// kryptonLabelLetteA
			// 
			kryptonLabelLetteA.AccessibleDescription = "Zeigt den Buchstabe A an";
			kryptonLabelLetteA.AccessibleName = "Buchstabe A";
			kryptonLabelLetteA.AccessibleRole = AccessibleRole.StaticText;
			kryptonLabelLetteA.Location = new Point(12, 12);
			kryptonLabelLetteA.Name = "kryptonLabelLetteA";
			...
			kryptonToolStrip.Items.AddRange(new ToolStripItem[] { toolStripButtonApply, toolStripButtonCancel });
		...
		private Krypton.Toolkit.KryptonLabel kryptonLabelLetteA;
