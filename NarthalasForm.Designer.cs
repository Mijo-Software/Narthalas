namespace Narthalas
{
    partial class NarthalasForm
    {
		...
		private void InitializeComponent()
		{
			...
			kryptonStatusStrip.Size = new Size(665, 22);
			...
			toolStripContainer.ContentPanel.Size = new Size(665, 408);
			...
			toolStripContainer.Size = new Size(665, 430);
			...
			kryptonPanelMain.Size = new Size(665, 408);
			...
			kryptonButtonHelp.Location = new Point(639, 0);
			...
			kryptonButtonLanguage.Location = new Point(0, 383);
			...
			kryptonButtonSettings.Location = new Point(639, 383);
